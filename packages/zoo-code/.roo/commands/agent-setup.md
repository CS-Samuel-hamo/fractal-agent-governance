...
```powershell
$workspace = "<workspace>"
$setup = "$env:USERPROFILE\.roo\agent-governance-kit\scripts\setup_zoo_agent.py"
...
2. Sync global `.roo` commands/rules and `$env:USERPROFILE\.roo\agent-governance-kit`.
