...
required = [
 'README.md','INSTALL.md','QUICKSTART.md','EXAMPLES.md','ARCHITECTURE.md','CLI_REFERENCE.md','BACKEND_PLUGINS.md','PROMPT_FOR_CODEX_APP.md','README_EXECUTION_STEPS.md','CHECKLIST.md',
