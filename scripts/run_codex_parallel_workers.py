...
def run_workers(args, repo_root: Path, contract: dict, output_dir: Path) -> list[dict]:
    ...
    while pending or running:
        while pending and len(running) < max_workers:
            ...
            stdout_path = worker_log_dir / 'dispatcher-stdout.txt'
            stderr_path = worker_log_dir / 'dispatcher-stderr.txt'
...
def main() -> int:
    ...
    report = {
        ...
        'parallel_denial_reason': contract.get('parallel_denial_reason', ''),
